...
@property BOOL isPlusMinusXlsxFileExistInDropbox;
@property BOOL isSecPlusMinusXlsxFileExistInDropbox;
...
@property BOOL isDownloadPlusMinusXlsxFileFinished;
@property BOOL isDownloadSecPlusMinusXlsxFileFinished;
@property BOOL isDeletePlusMinusXlsxFileFinished;
@property BOOL isDeleteSecPlusMinusXlsxFileFinished;
@property BOOL isFstPlusMinusGenerateAndUploadFinished;
